...
By a proposition we mean a type with at most one element (any two of
its elements are equal in the sense of the identity type). The
existential quantification symbol \m{\exists} denotes the
...
We are able to construct plenty of compact types, and it turns out
they all can be equipped with well-orders making them into ordinals.
...
compact ordinals we construct are, moreover, order-compact in the
...
We define infinitary ordinal codes, or expressions, similar to Brouwer
