...
pt-pf-equiv : {X : U ̇} (x : X) → Σ \(f : identifications-from x → identifications-to x) → is-equiv f
...
identifications-to-singleton : {X : U ̇} (x : X) → is-singleton(identifications-to x)
