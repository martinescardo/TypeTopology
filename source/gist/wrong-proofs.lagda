...
The conclusion of the above discussion is that the following proofs are not
wrong if you read Jesper Cockx's PhD thesis, linked in the above
discussion.

Apparently, although nobody elaborated on that precisely (as of Sat 20 Dec
17:15 GMT), the following "wrong" proofs translate to the known proofs by
the encode-decode method.

I will keep this file as it is, so that the above discussion can be
understood in the original context.
