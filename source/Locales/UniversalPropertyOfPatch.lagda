...
\begin{code}
 ...
 module UniversalPropertyOfPatch (X  : Locale (𝓤 ⁺) 𝓤 𝓤)
  ...
  f⁻⋆ j =
   ⋁[ 𝒪 X ]
    ⁅ (𝒻 ⋆∙ β m) ∧[ 𝒪 X ] ¬𝒻⋆ n ∣ (m , n , p) ∶ Σ m ꞉ Bₐ , Σ n ꞉ Bₐ , 𝕃 j m n holds ⁆

  f⁻⋆₂ : ⟨ 𝒪 Patchₛ-A ⟩ → ⟨ 𝒪 X ⟩
  f⁻⋆₂ 𝒿@(j , _) = ⋁[ 𝒪 X ] ⁅ 𝒻 ⋆∙ j (β n) ∧[ 𝒪 X ] ¬𝒻⋆ n ∣ n ∶ Bₐ ⁆
              ...
              where
               ...
               ϡ (o , p) = ∣ o , ϟ ∣
                where
                 ...
                 𝕒₂ = ap
                       (λ - → 𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] -)
                       (∧[ 𝒪 X ]-is-associative (¬𝒻⋆ m) (𝒻 ⋆∙ k (β n)) (¬𝒻⋆ n))
                 𝕒₃ = ap
                       (λ - → 𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] (- ∧[ 𝒪 X ] ¬𝒻⋆ n))
                       (∧[ 𝒪 X ]-is-commutative (¬𝒻⋆ m) (𝒻 ⋆∙ k (β n)))
                 𝕒₄ = ap
                       (λ - → 𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] -)
                       (∧[ 𝒪 X ]-is-associative (𝒻 ⋆∙ k (β n)) (¬𝒻⋆ m) (¬𝒻⋆ n) ⁻¹)
                 𝕒₅ = ∧[ 𝒪 X ]-is-associative
                       (𝒻 ⋆∙ j (β m))
                       (𝒻 ⋆∙ k (β n))
                       (¬𝒻⋆ m ∧[ 𝒪 X ] ¬𝒻⋆ n)
                 ...
                 𝕒  = (𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] ¬𝒻⋆ m) ∧[ 𝒪 X ] (𝒻 ⋆∙ k (β n) ∧[ 𝒪 X ] ¬𝒻⋆ n)     ＝⟨ 𝕒₁ ⟩
                      𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] (¬𝒻⋆ m ∧[ 𝒪 X ] (𝒻 ⋆∙ k (β n) ∧[ 𝒪 X ] ¬𝒻⋆ n))     ＝⟨ 𝕒₂ ⟩
                      𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] ((¬𝒻⋆ m ∧[ 𝒪 X ] 𝒻 ⋆∙ k (β n)) ∧[ 𝒪 X ] ¬𝒻⋆ n)     ＝⟨ 𝕒₃ ⟩
                      𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] (𝒻 ⋆∙ (k (β n)) ∧[ 𝒪 X ] ¬𝒻⋆ m ∧[ 𝒪 X ] ¬𝒻⋆ n)     ＝⟨ 𝕒₄ ⟩
                      𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] (𝒻 ⋆∙ (k (β n)) ∧[ 𝒪 X ] (¬𝒻⋆ m ∧[ 𝒪 X ] ¬𝒻⋆ n))   ＝⟨ 𝕒₅ ⟩
                      (𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] 𝒻 ⋆∙ (k (β n))) ∧[ 𝒪 X ] (¬𝒻⋆ m ∧[ 𝒪 X ] ¬𝒻⋆ n)   ＝⟨ 𝕒₆ ⟩
                      (𝒻 ⋆∙ (j (β m) ∧[ 𝒪 A ] k (β n))) ∧[ 𝒪 X ] (¬𝒻⋆ m ∧[ 𝒪 X ] ¬𝒻⋆ n)        ∎
                 ...
                 𝕕 = ap
                      ...
                      (frame-homomorphisms-preserve-meets
                        ...
                        (k (β o)))
                 𝕖 =
                  (𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] 𝒻 ⋆∙ k (β o)) ∧[ 𝒪 X ] ¬𝒻⋆ o                  ＝⟨ 𝟏 ⟩
                  (𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] 𝒻 ⋆∙ k (β o)) ∧[ 𝒪 X ] (¬𝒻⋆ o ∧[ 𝒪 X ] ¬𝒻⋆ o) ＝⟨ 𝟐 ⟩
                  𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] (𝒻 ⋆∙ k (β o) ∧[ 𝒪 X ] (¬𝒻⋆ o ∧[ 𝒪 X ] ¬𝒻⋆ o)) ＝⟨ 𝟑 ⟩
                  𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] ((𝒻 ⋆∙ k (β o) ∧[ 𝒪 X ] ¬𝒻⋆ o) ∧[ 𝒪 X ] ¬𝒻⋆ o) ＝⟨ 𝟒 ⟩
                  𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] ((¬𝒻⋆ o ∧[ 𝒪 X ] 𝒻 ⋆∙ k (β o)) ∧[ 𝒪 X ] ¬𝒻⋆ o) ＝⟨ 𝟓 ⟩
                  𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] (¬𝒻⋆ o ∧[ 𝒪 X ] (𝒻 ⋆∙ k (β o) ∧[ 𝒪 X ] ¬𝒻⋆ o)) ＝⟨ 𝟔 ⟩
                  (𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] ¬𝒻⋆ o) ∧[ 𝒪 X ] (𝒻 ⋆∙ k (β o) ∧[ 𝒪 X ] ¬𝒻⋆ o) ∎
                   where
                    𝟏 = ap
                         (λ - → (𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] 𝒻 ⋆∙ k (β o)) ∧[ 𝒪 X ] -)
                         (∧[ 𝒪 X ]-is-idempotent (¬𝒻⋆ o))
                    ...
                    𝟑 = ap
                         (λ - → 𝒻 ⋆∙ (j (β o)) ∧[ 𝒪 X ] -)
                         (∧[ 𝒪 X ]-is-associative (𝒻 ⋆∙ k (β o)) (¬𝒻⋆ o) (¬𝒻⋆ o))
                    𝟒 = ap
                         (λ - → 𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] (- ∧[ 𝒪 X ] ¬𝒻⋆ o))
                         (∧[ 𝒪 X ]-is-commutative (𝒻 ⋆∙ k (β o)) (¬𝒻⋆ o))
                    𝟓 = ap
                         (λ - → 𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] -)
                         (∧[ 𝒪 X ]-is-associative (¬𝒻⋆ o) (𝒻 ⋆∙ k (β o)) (¬𝒻⋆ o) ⁻¹)
                 ...
                 ϟ = (𝒻 ⋆∙ j (β m) ∧[ 𝒪 X ] ¬𝒻⋆ m) ∧[ 𝒪 X ] (𝒻 ⋆∙ k (β n) ∧[ 𝒪 X ] ¬𝒻⋆ n)   ＝⟨ 𝕒 ⟩ₚ
                     ...
                     𝒻 ⋆∙ (j (β o) ∧[ 𝒪 A ] k (β o)) ∧[ 𝒪 X ] ¬𝒻⋆ o                         ＝⟨ 𝕕 ⟩ₚ
                     (𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] 𝒻 ⋆∙ k (β o)) ∧[ 𝒪 X ] ¬𝒻⋆ o                    ＝⟨ 𝕖 ⟩ₚ
                     (𝒻 ⋆∙ j (β o) ∧[ 𝒪 X ] ¬𝒻⋆ o) ∧[ 𝒪 X ] (𝒻 ⋆∙ k (β o) ∧[ 𝒪 X ] ¬𝒻⋆ o)   ■
