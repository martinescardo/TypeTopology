        ...
        where
         ...
         ♣ (k , t) = ∣ (k ∷ ks′) , ♢ ∣
          where
           ...
           η : ↑ˢ[ s , κ ] ＝ ↑ˢ[ β i , ϟ i ] ∧[ 𝒪 𝒮𝓓 ] ↑ˢ[ β j , ϟ j ]
           η = principal-filter-reflects-joins (β i) (β j) s (ϟ i) (ϟ j) (pr₂ ς)

           ϡ : (↑ˢ[ s , κ ] ⊆ₖ ↑ˢ[ β i , ϟ i ]) holds
           ϡ = transport
                (λ - → (- ⊆ₖ ↑ˢ[ β i , ϟ i ]) holds)
                (η ⁻¹)
                (∧[ 𝒪 𝒮𝓓 ]-lower₁ ↑ˢ[ β i , ϟ i ] ↑ˢ[ β j , ϟ j ])

           ϝ : (↑ˢ[ s , κ ] ⊆ₖ ↑ˢ[ β j , ϟ j ]) holds
           ϝ = transport
                (λ - → (- ⊆ₖ ↑ˢ[ β j , ϟ j ]) holds)
                (η ⁻¹)
                (∧[ 𝒪 𝒮𝓓 ]-lower₂ ↑ˢ[ β i , ϟ i ] ↑ˢ[ β j , ϟ j ])
           ...
           φ : (𝓁𝒽𝓈 ⊆ₖ 𝓇𝒽𝓈) holds
           φ k (p₁ , p₂) = ∥∥-rec₂ (holds-is-prop (β k ∈ₛ 𝓇𝒽𝓈)) ρ p₁ p₂
            where
             ρ : (Σ b₁ ꞉ 𝟚 𝓤 , (β k ∈ₛ (⁅ ↑ˢ[ s , κ ] , γ₁ is ⁆ [ b₁ ])) holds)
               → (Σ b₂ ꞉ 𝟚 𝓤 , (β k ∈ₛ (⁅ ↑ˢ[ s , κ ] , γ₁ js ⁆ [ b₂ ])) holds)
               → (β k ∈ₛ 𝓇𝒽𝓈) holds
             ρ (inl ⋆ , p) _ = (∨[ 𝒪 𝒮𝓓 ]-upper₁ ↑ˢ[ β i , ϟ i ] (γ₁ is) k (ϡ k p))
                             , (∨[ 𝒪 𝒮𝓓 ]-upper₁ ↑ˢ[ β j , ϟ j ] (γ₁ js) k (ϝ k p))
             ρ (inr ⋆ , p) (inl ⋆ , q) = (∨[ 𝒪 𝒮𝓓 ]-upper₁ ↑ˢ[ β i , ϟ i ] (γ₁ is) k (ϡ k q))
                                       , (∨[ 𝒪 𝒮𝓓 ]-upper₁ ↑ˢ[ β j , ϟ j ] (γ₁ js) k (ϝ k q))
             ρ (inr ⋆ , p) (inr ⋆ , q) = (∨[ 𝒪 𝒮𝓓 ]-upper₂ ↑ˢ[ β i , ϟ i ] (γ₁ is) k p)
                                       , ∨[ 𝒪 𝒮𝓓 ]-upper₂ ↑ˢ[ β j , ϟ j ] (γ₁ js) k q

           ψ : (𝓇𝒽𝓈 ⊆ₖ 𝓁𝒽𝓈) holds
           ψ k (p₁ , p₂) = ∥∥-rec₂ (holds-is-prop (β k ∈ₛ 𝓁𝒽𝓈)) ρ p₁ p₂
            where
             ρ : (Σ b₁ ꞉ 𝟚 𝓤 , (β k ∈ₛ (⁅ ↑ˢ[ β i , ϟ i ] , γ₁ is ⁆ [ b₁ ])) holds)
               → (Σ b₂ ꞉ 𝟚 𝓤 , (β k ∈ₛ (⁅ ↑ˢ[ β j , ϟ j ] , γ₁ js ⁆ [ b₂ ])) holds)
               → (β k ∈ₛ 𝓁𝒽𝓈) holds
             ρ (inl ⋆ , p) (inl ⋆ , q)  = {!!}
             ρ (inl ⋆ , p) (inr ⋆ , q)  = {!!}
             ρ (inr ⋆ , p) (inl ⋆ , q)  = {!!}
             ρ (inr ⋆ , p) (inr ⋆ , q)  = (∨[ 𝒪 𝒮𝓓 ]-upper₂ ↑ˢ[ s , κ ] (γ₁ is) k p)
                                        , (∨[ 𝒪 𝒮𝓓 ]-upper₂ ↑ˢ[ s , κ ] (γ₁ js) k q)
