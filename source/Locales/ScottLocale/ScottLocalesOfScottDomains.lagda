        ...
        where
         ...
         ♣ (k , t) = ∣ (k ∷ ks′) , ♢ ∣
          where
           ...
           ♢ =
            ↑ˢ[ β k , ϟ k ] ∨[ 𝒪 𝒮𝓓 ] γ₁ ks′                                              ＝⟨ ap (λ - → - ∨[ 𝒪 𝒮𝓓 ] γ₁ ks′) {!p!} ⟩
            ↑ˢ[ s , κ ] ∨[ 𝒪 𝒮𝓓 ] γ₁ ks′                                                  ＝⟨ ap (λ - → binary-join (𝒪 𝒮𝓓) ↑ˢ[ s , κ ] -) p ⟩
            ↑ˢ[ s , κ ] ∨[ 𝒪 𝒮𝓓 ] (γ₁ is ∧[ 𝒪 𝒮𝓓 ] γ₁ js)                                 ＝⟨ {!!} ⟩
            (↑ˢ[ β i , ϟ i ] ∧[ 𝒪 𝒮𝓓 ] ↑ˢ[ β j , ϟ j ]) ∨[ 𝒪 𝒮𝓓 ] (γ₁ is ∧[ 𝒪 𝒮𝓓 ] γ₁ js) ＝⟨ {!!} ⟩
