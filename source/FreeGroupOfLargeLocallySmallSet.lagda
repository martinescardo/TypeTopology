...
https://arxiv.org/abs/2102.08812).
...
We work with an arbitrary locally small generating set A : 𝓤⁺ which
will be instantiated to the type of ordinals in 𝓤 in the very last
step of this file to obtain the desired result.

Because of the way we construct quotients, the group freely generated
by A lives in the universe 𝓤⁺⁺ rather than 𝓤⁺. Our first step is to
reduce the size of the free group to 𝓤⁺. The last three assumptions in
the following module parameters are a weakening of the local smallness
condition.
