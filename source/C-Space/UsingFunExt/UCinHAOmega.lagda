...
`C-Space.Syntax.HAOmega` and `TdefinableFunctionsAreUC`. This module adds the
...
module C-Space.UsingFunExt.UCinHAOmega (fe : DN-funext 𝓤₀ 𝓤₀) where
...
open import C-Space.Syntax.HAOmega
