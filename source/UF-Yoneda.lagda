...
yoneda-elem-is-equiv : (∀ 𝓤 𝓥 → funext 𝓤 𝓥)
                     → {X : 𝓤 ̇} (x : X) (A : X → 𝓥 ̇)
...
yoneda-nat-is-equiv : (∀ 𝓤 𝓥 → funext 𝓤 𝓥)
                    → {X : 𝓤 ̇} (x : X) (A : X → 𝓥 ̇)
...
yoneda-equivalence : (∀ 𝓤 𝓥 → funext 𝓤 𝓥)
                   → {X : 𝓤 ̇} (x : X) (A : X → 𝓥 ̇)
                   → A x ≃ Nat (Id x) A
...
nat-retraction-is-section-uniquely : (∀ 𝓤 𝓥 → funext 𝓤 𝓥) → {X : 𝓤 ̇} {A : X → 𝓥 ̇}
                                     (x : X) (η : Nat (Id x) A)
                                   → ((y : X) → has-section(η y))
...
nat-having-section-is-a-prop : (∀ 𝓤 𝓥 → funext 𝓤 𝓥) → {X : 𝓤 ̇} {A : X → 𝓥 ̇}
                               (x : X) (η : Nat (Id x) A)
...
yoneda-equivalence-Σ : (∀ 𝓤 𝓥 → funext 𝓤 𝓥) → {X : 𝓤 ̇} (A : X → 𝓥 ̇)
