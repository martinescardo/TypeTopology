...
η-∿ a a' e = srt-transitive _▷_ (η a) w (η a')
              (srt-symmetric _▷_ w (η a) (srt-extension _▷_ w (η a) w▷ηa))
              (srt-extension _▷_ w (η a') w▷ηa')
 where
  w : FA
  w = (₀ , a) • (₁ , a') • (₀ , a') • []
...
small-copy-gives-small-setoid 𝓖 (F , (F-resp , _) , G , (G-resp , _) , FG , GF)
 ...
 where
  ...
  abstract
   ...
   to-from-gen : (y : ⟨ 𝓖 ⟩) (w : generator (F y)) → to-gen y (from-gen y w) ＝ w
   to-from-gen y =
