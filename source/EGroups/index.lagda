 ...
 * Setoid
   ...
   data, not required to be proposition-valued) and minimal setoid
   infrastructure.
 ...
 * MediatingMap
   ...
   This is for use in the next two modules.
 ...
 * Large
   ...
   The egroup freely generated by a large type is itself large (has no
   small copy).
