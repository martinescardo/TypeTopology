...
the following paper:
Christensen, J.D. (2024), Non-accessible localizations.
...
the universe parameter 𝓥 as our point of reference for 'smallness'.
...
\begin{code}
 ...
 locally-small-closed-under-≃ : {X : 𝓤 ̇} {Y : 𝓦 ̇} {n : ℕ}
                              → X ≃ Y
                              → X is n locally-small
                              → Y is n locally-small
 locally-small-closed-under-≃ {_} {_} {_} {_} {zero} e X-small =
  smallness-closed-under-≃ X-small e
 locally-small-closed-under-≃ {_} {_} {_} {_} {succ n} e X-loc-small y y' =
  locally-small-closed-under-≃ path-equiv (X-loc-small (⌜ e ⌝⁻¹ y) (⌜ e ⌝⁻¹ y'))
  where
   path-equiv : (⌜ e ⌝⁻¹ y ＝ ⌜ e ⌝⁻¹ y') ≃ (y ＝ y')
   path-equiv = ≃-sym (ap ⌜ e ⌝⁻¹ , ap-is-equiv ⌜ e ⌝⁻¹ (⌜⌝⁻¹-is-equiv e))

 locally-small-closed-under-Σ : {X : 𝓤 ̇} {Y : X → 𝓦 ̇} {n : ℕ}
                              → X is n locally-small
                              → ((x : X) → (Y x) is n locally-small)
                              → (Σ x ꞉ X , Y x) is n locally-small
 locally-small-closed-under-Σ {_} {_} {_} {_} {zero} X-small Y-small =
  Σ-is-small X-small Y-small
 locally-small-closed-under-Σ {_} {_} {_} {Y} {succ n}
  X-loc-small Y-loc-small (x , y) (x' , y') =
  locally-small-closed-under-≃ (≃-sym Σ-＝-≃)
   (locally-small-closed-under-Σ (X-loc-small x x')
 ...
 locally-small-closed-under-truncation : {X : 𝓤 ̇} {n : ℕ₋₂}
                                       → X is ι (n + 2) locally-small
                                       → ∥ X ∥[ n ] is ι (n + 2) locally-small
 locally-small-closed-under-truncation {_} {X} {−2} =
  truncations-of-small-types-are-small
 locally-small-closed-under-truncation {_} {X} {succ n} X-loc-small =
  ∥∥ₙ-ind₂ (λ u v → (u ＝ v) is ι (n + 2) locally-small)
           ...
           (λ x y → locally-small-closed-under-≃
                     (eliminated-trunc-identity-char (ua _))
                    (locally-small-closed-under-truncation (X-loc-small x y)))
...
\begin{code}
 ...
 Lemma-2-4 {_} {_} {_} {_} {f} {_} pr f-trunc Y-loc-small =
  locally-small-closed-under-≃ (total-fiber-is-domain f)
   (locally-small-closed-under-Σ Y-loc-small (λ y → Lemma-2-3 pr (f-trunc y)))
   ...
   trunc-ind-helper x' = Prop-2-2 j f-con 𝟙-is-small cod-locally-small
    where
     ...
     cod-locally-small : (Σ x ꞉ X , ∣ x ∣[ n + 1 ] ＝ ∣ x' ∣[ n + 1 ]) is
                          ι (n + 2) locally-small
     cod-locally-small = locally-small-closed-under-Σ X-loc-small
                          path-locally-small
      where
       ...
       path-locally-small x =
        locally-small-closed-under-≃ (eliminated-trunc-identity-char (ua _))
                                     path-char-locally-small
         where
          path-char-locally-small : ∥ x ＝ x' ∥[ n ] is ι (n + 2) locally-small
          path-char-locally-small =
           locally-small-closed-under-truncation
            (locally-small-is-upper-closed X-loc-small x x')
 ...
 Theorem-2-6 {_} {X} {n} j =
  ...
  where
   foreward : X is 𝓥 small
            → X is ι (n + 2) locally-small × ∥ X ∥[ n + 1 ] is 𝓥 small
   foreward X-small =
    (locally-small-from-small X-small
