...
Lift-id : {𝓤 𝓥 : Universe} (X : 𝓤 ̇) (Y : 𝓥 ̇) → (𝓤 ⊔ 𝓥)⁺ ̇
Lift-id {𝓤} {𝓥} X Y = Lift 𝓥 X ＝ Lift 𝓤 Y

_＝ᴸ_ : (X : 𝓤 ̇) (Y : 𝓥 ̇) → (𝓤 ⊔ 𝓥)⁺ ̇
X ＝ᴸ Y = Lift-id X Y
...
＝ᴸ-trans : {X : 𝓤 ̇} {Y : 𝓥 ̇} {Z : 𝓦 ̇}
          → X ＝ᴸ Y
          → Y ＝ᴸ Z
          → Lift (𝓥 ⊔ 𝓦) X ＝ Lift (𝓤 ⊔ 𝓥) Z
＝ᴸ-trans {𝓤} {𝓥} {𝓦} {X} {Y} {Z} p q = III'
 where
  I : Lift 𝓥 X ＝ Lift 𝓤 Y
  I = p
  II : Lift 𝓦 Y ＝ Lift 𝓥 Z
  II = q
  III' : Lift (𝓥 ⊔ 𝓦) X ＝ Lift (𝓤 ⊔ 𝓥) Z
  III' = {!!}
  III : Lift 𝓦 X ＝ Lift 𝓤 Z
  III = {!!}
...
⊰-is-anti-symmetric {𝓤} {𝓥} ua o o'
 ...
 where
  ...
  I = Lift (𝓥 ⁺) (𝓤 ̇) ≃⟨ Lift-≃ (𝓥 ⁺) (𝓤 ̇) ⟩
      𝓤 ̇              ≃⟨ ⊰-is-anti-symmetric-≃ ua o o' ⟩
      𝓥 ̇              ≃⟨ ≃-Lift (𝓤 ⁺) (𝓥 ̇) ⟩
      Lift (𝓤 ⁺) (𝓥 ̇) ■
