...
... | inl even = let y = rec k downLeft n 
                     z = (y +ℤ y) in 
                 normalise (z +ℤ z , (succℤ (pos (succ δ) +ℤ pos n))) ≡⟨ ap (λ - → normalise (z +ℤ z , succℤ -)) (pos-addition-equiv-to-ℕ (succ δ) n) ⟩
                 ...
                 normalise (z , pos (succ δ + n))                  ≡⟨ ap (λ - → normalise (z , -)) (pos-addition-equiv-to-ℕ (succ δ) n ⁻¹) ⟩
