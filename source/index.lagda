   ...
   Abstract. The main new results are about compact types, totally
   separated types, compact ordinals and injective types, but there
   are many other things - see the clickable index below.
                           -----------------------------
   ...
   * We offer this page as a preliminary announcement of results to be
     eventually written down in mathematical vernacular and submitted
     for publication, of the kind we would get when we visit a
   ...
   * HoTT/UF is a prerequisite, rather than the objective. The
     required material on HoTT/UF has been developed on demand over
     the years to fullfil the needs of the above as they arise, and
     hence is somewhat chaotic. It will continue to expand as the need
     arises. Its form is the result of evolution rather than
     intelligent design (paraphrasing Linus Torvalds).

     Our lecture notes develop HoTT/UF in Agda in a more principled
     way, and offer better approaches to some constructions and
     ...
     As a consequence, we are able to tell very precisely which
     assumptions of HoTT/UF and classical mathematics, if any, we have
     used for each construction, theorem or set of results. We also
     work, deliberately, with a minimal subset of Agda.

   * I am not a formalist, and I am not a constructivist. But I like
     the rigour given by formalism, and in particular I like to have
     the computer as a referee that allows me to announce results
     before they are published, without fear of embarrassment.

     And I personally find constructive mathematics very pleasing. The
     only reason I do constructive mathematics is that I love it. If I
     didn't, I wouldn't do it. I don't need philosophy (or counseling
     https://www.ams.org/journals/bull/2017-54-03/S0273-0979-2016-01556-4/)
     to like it. I am probably a constructive platonist. I see things,
     and I try to write them down to tell you (and the computer, for
     refereeing purses) about them.

   * Regarding the contents of this development, there is also a
     module that links some "unsafe" modules that use type theory
     beyond MLTT and HoTT/UF, which cannot be included in this
     safe-modules index: The system with type-in-type is inconsistent
     (as is well known), countable Tychonoff, and compactness of the
     Cantor type using countable Tychonoff.
   ...
   * A module dependency graph is available, updated manually from
     ...
     In our last count, this development has 40000 lines, including
