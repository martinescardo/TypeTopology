...
image-of-subset : ((X , sX) (Y , sY) : hSet 𝓤) → (f : X → Y) → (A : X → Ω 𝓤) → (Y → Ω 𝓤)
 ...
 ⇔-affirmable (Ǝₚ y' ꞉ Y , ((X y' ∧ (y ＝ y') , sY))) (X y) (p₁ , p₂) †
  where
   ...
   p₁ = λ ex-equal → ∥∥-rec
                                     (holds-is-prop (X y))
                                     (λ (y' , Xy' , y-equals-y')
                                       → transport (λ i → pr₁ (X i)) (y-equals-y' ⁻¹)  Xy')
                                     ex-equal
...
subovert-inter-open-subovert : closed-under-binary-meets holds
                                                            ...
                                                            → (Ɐ A ꞉ (X → Ω 𝓤) ,
                                                                   Ɐ (U , _) ꞉ 𝓞 (X , sX) ,
                                                                     is-subovert (X , sX) A
                                                                      ⇒ is-subovert (X , sX) (λ x → (A x ∧ U x))) holds
subovert-inter-open-subovert cl-∧ (X , sX) A (U , open-U) subovert-A (V , open-V) =
...
open-subset-of-overt-is-subovert cl-∧ (X , sX) (U , open-U) overt-X (V , open-V) =
 overt-X ((λ x → (U x ∧ V x)) , (λ x → cl-∧ (U x) (V x) ((open-U x , open-V x))))
...
image-of-subovert : ((X , sX) (Y , sY) : hSet 𝓤)
                                ...
                                → (Ɐ A ꞉ (X → Ω 𝓤) ,
                                       is-subovert (X , sX) A
                                        ⇒ is-subovert (Y , sY) (image-of-subset (X , sX) (Y , sY) f A)) holds 
 ...
 ⇔-affirmable x'-exists y-exists (p₁ , p₂) †
  where
   ...
   p₂ = λ y-hyp → ∥∥-rec (holds-is-prop x'-exists)
    ...
    where
     x-exists-gives-x' : (Σ y ꞉ Y , (Ǝₚ x ꞉ X , (A x ∧ (f x ＝ y) , sY) ∧ P y) holds)
                                            → x'-exists holds
...
compact-iff-subcompact-in-self :
 ((X , sX) : hSet 𝓤) → ((is-compact (X , sX)) ⇔(is-subcompact (X , sX) (λ x → ⊤))) holds
...
overt-iff-subovert-in-self (X , sX) = overt-gives-subovert , subovert-gives-overt
 ...
 where
  ...
  p₁ : ((U , open-U) : 𝓞 (X , sX)) → (x-exists (U , open-U) ⇒ x-⊤-exists (U , open-U)) holds
  ...
  p₂ : ((U , open-U) : 𝓞 (X , sX)) → (x-⊤-exists (U , open-U) ⇒ x-exists (U , open-U)) holds
  p₂ (U , open-U) = λ ex-x-⊤ → ∥∥-rec (holds-is-prop (x-exists (U , open-U)))
                                                                    (λ (x , ⊤-Ux) → ∣ x , ∧-Elim-R ⊤ (U x) ⊤-Ux ∣)
                                                                    ex-x-⊤

  overt-gives-subovert : ((is-overt (X , sX)) ⇒ (is-subovert (X , sX) (λ x → ⊤))) holds
  ...
  subovert-gives-overt : (is-subovert (X , sX) (λ x → ⊤) ⇒ (is-overt (X , sX))) holds
