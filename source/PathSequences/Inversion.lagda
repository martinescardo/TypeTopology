...
seq⁻¹-involutive : {x x' : X} (s : x ≡ x')
                 → seq⁻¹ (seq⁻¹ s) ＝ s
seq⁻¹-involutive [] = refl
seq⁻¹-involutive (p ◃∙ s) = seq⁻¹ (seq⁻¹ s ∙▹ (p ⁻¹))      ＝⟨ seq⁻¹-∙▹ (seq⁻¹ s) (p ⁻¹) ⟩
                            ((p ⁻¹) ⁻¹) ◃∙ seq⁻¹ (seq⁻¹ s) ＝⟨ ap₂ _◃∙_ (⁻¹-involutive p) (seq⁻¹-involutive s) ⟩
                            p ◃∙ s ∎

sym-[↓]-seq⁻¹ : {x x' : X} (s : x ≡ x')
              → ([ s ↓] ⁻¹) ◃∎ ＝ₛ seq⁻¹ s
sym-[↓]-seq⁻¹ [] = ＝ₛ-in refl
sym-[↓]-seq⁻¹ (p ◃∙ s) = ([(p ◃∙  s) ↓] ⁻¹) ◃∎     ＝ₛ⟨ ＝ₛ-in refl ⟩
...
seq⁻¹-＝ₛ : {x x' : X} {s t : x ≡ x'}
          → s ＝ₛ t
          → seq⁻¹ s ＝ₛ seq⁻¹ t
seq⁻¹-＝ₛ {s = s} {t} e = seq⁻¹ s          ＝ₛ⟨ seq⁻¹-sym-[↓] s ⟩
                         ([ s ↓] ⁻¹) ◃∎   ＝↓⟨ ap (λ v → v ⁻¹) (＝ₛ-out e) ⟩
                         ([ t ↓] ⁻¹) ◃∎   ＝ₛ⟨ sym-[↓]-seq⁻¹ t ⟩
                         seq⁻¹ t ∎ₛ
...
seq⁻¹-right-inverse : {x x' : X} (s : x ≡ x')
                    → s ∙≡ seq⁻¹ s ＝ₛ []
seq⁻¹-right-inverse s = ＝ₛ-in ( [ s ∙≡ seq⁻¹ s ↓]     ＝⟨ [↓]-hom s (seq⁻¹ s) ⁻¹ ⟩
