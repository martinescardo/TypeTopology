     ...
     where
      ...
      the-real-thing (inr b , (e' , inl ⋆) , p) = _ , foo
       where
        foo = (exp (𝟙ₒ +ₒ α) β ↓ e) ＝⟨ ↓-eq-lemma (exp (𝟙ₒ +ₒ α) β) (sup (cases (λ _ → 𝟙ₒ) (λ b₁ → exp (𝟙ₒ +ₒ α) (β ↓ b₁) ×ₒ (𝟙ₒ +ₒ α)))) e (exp-behaviour (𝟙ₒ +ₒ α) β) ⟩
              (sup (cases (λ _ → 𝟙ₒ) (λ b₁ → exp (𝟙ₒ +ₒ α) (β ↓ b₁) ×ₒ (𝟙ₒ +ₒ α))) ↓ x) ＝⟨ fact ⟩
              (sup (cases (λ _ → 𝟙ₒ) (λ b₁ → exp (𝟙ₒ +ₒ α) (β ↓ b₁) ×ₒ (𝟙ₒ +ₒ α))) ↓ y) ＝⟨ initial-segment-of-sup-at-component _ (inr b) (e' , inl ⋆) ⟩
              ((exp (𝟙ₒ +ₒ α) (β ↓ b) ×ₒ (𝟙ₒ +ₒ α)) ↓ (e' , inl ⋆)) ＝⟨ ×ₒ-↓ (exp (𝟙ₒ +ₒ α) (β ↓ b)) (𝟙ₒ +ₒ α) ⟩
              (((exp (𝟙ₒ +ₒ α) (β ↓ b)) ×ₒ ((𝟙ₒ +ₒ α) ↓ inl ⋆)) +ₒ (exp (𝟙ₒ +ₒ α) (β ↓ b) ↓ e')) ＝⟨ calc ⟩
              (𝟘ₒ +ₒ (exp (𝟙ₒ +ₒ α) (β ↓ b) ↓ e')) ＝⟨ 𝟘ₒ-left-neutral _ ⟩
              (exp (𝟙ₒ +ₒ α) (β ↓ b) ↓ e') ＝⟨ ↓-eq-lemma (exp (𝟙ₒ +ₒ α) (β ↓ b)) ([𝟙+ α ]^ (β ↓ b)) e' (IH b) ⟩
              (([𝟙+ α ]^ (β ↓ b)) ↓ e'') ＝⟨ fact' ⟩
              (([𝟙+ α ]^ β) ↓ pr₁ σ e'') ∎
         where
          x : ⟨ sup (cases (λ _ → 𝟙ₒ) (λ b₁ → exp (𝟙ₒ +ₒ α) (β ↓ b₁) ×ₒ (𝟙ₒ +ₒ α))) ⟩
      ...
      the-real-thing (inr b , (e' , inr a) , p) = _ , foo
       where
        foo = (exp (𝟙ₒ +ₒ α) β ↓ e) ＝⟨ ↓-eq-lemma (exp (𝟙ₒ +ₒ α) β) (sup (cases (λ _ → 𝟙ₒ) (λ b₁ → exp (𝟙ₒ +ₒ α) (β ↓ b₁) ×ₒ (𝟙ₒ +ₒ α)))) e (exp-behaviour (𝟙ₒ +ₒ α) β) ⟩
              ...
              ((exp (𝟙ₒ +ₒ α) (β ↓ b) ×ₒ (𝟙ₒ +ₒ α)) ↓ (e' , inr a)) ＝⟨ ×ₒ-↓ (exp (𝟙ₒ +ₒ α) (β ↓ b)) (𝟙ₒ +ₒ α) ⟩
              (((exp (𝟙ₒ +ₒ α) (β ↓ b)) ×ₒ ((𝟙ₒ +ₒ α) ↓ inr a)) +ₒ (exp (𝟙ₒ +ₒ α) (β ↓ b) ↓ e')) ＝⟨ calc ⟩
    ...
    III _ ((((a , b) ∷ l) , δ) , refl) = _ , foo
     where
      foo = (([𝟙+ α ]^ β) ↓ ((a , b ∷ l) , δ)) ＝⟨ eqtoidₒ (ua 𝓤) fe' _ _ ([𝟙+]^-↓-lemma α β a b l δ) ⟩
            ...
            ((exp (𝟙ₒ +ₒ α) (β ↓ b) ×ₒ (𝟙ₒ +ₒ (α ↓ a))) +ₒ (exp (𝟙ₒ +ₒ α) (β ↓ b) ↓ l'')) ＝⟨ calc ⟩
