...
with Π is freely generated by a set of generators G, then the
...
open import Lifting.TwoAlgebrasOnOmega 𝓣 fe pe renaming (Π-algebra-on-Ω to ΩΠ)
...
Ω equipped with the structure map Π is indeed freely generated by G
...
\begin{code}
 ...
 h : 𝓛 G → Ω
 h = 𝓛-extension (Ω-is-set fe pe) ΩΠ ι

 h-explicitly : h ∼ λ (P , φ , i) → Ɐ p ꞉ P , ι (φ p)
 h-explicitly _ = refl

 h-is-hom : is-hom free ΩΠ h
 h-is-hom = 𝓛-extension-is-hom (Ω-is-set fe pe) ΩΠ ι

 h-extends-ι : h ∘ η ∼ ι
 h-extends-ι = 𝓛-extension-extends (Ω-is-set fe pe) ΩΠ ι
...
with the structure map Π is freely generated by G with insertion of
generators ι.

\begin{code}

 module assumption
         (ΩΠ-is-free : is-𝓛-alg ΩΠ freely-generated-by G
...
by G with insertion of generators η, and Ω is freely generated by G
with insertion of generators ι. So the conclusion is a standard
...
\begin{code}
  ...
  module E = free-algebra-eliminators
              ΩΠ G ι (𝓣 ⁺) ΩΠ-is-free (𝓛-is-set fe fe pe G-is-set) free η
  ...
  h-is-equiv = qinvs-are-equivs h (h⁻¹ , III , IV)
   where
    ...
    I = ∘-is-hom free ΩΠ free h h⁻¹ h-is-hom h⁻¹-is-hom

    II : is-hom ΩΠ ΩΠ (h ∘ h⁻¹)
    II = ∘-is-hom ΩΠ free ΩΠ h⁻¹ h h⁻¹-is-hom h-is-hom
    ...
    IV = at-most-one-extending-hom'
     ...
     where
      open free-algebra-eliminators
            ΩΠ G ι (𝓣 ⁺) ΩΠ-is-free (Ω-is-set fe pe) ΩΠ ι
