...
In the introduction to this file, we claimed that if Ω∀ is freely
generated by ⊥ : Ω, then the topos is boolean. This is a particular
case of the above development.
