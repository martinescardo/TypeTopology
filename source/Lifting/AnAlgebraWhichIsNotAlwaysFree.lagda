...
We show that if this is the case, then
 ...
 2. the insertion of generators ι : G → Ω is constant with value ⊥, and
 3. G ≃ 𝟙.
...
every-element-of-𝓛-is-a-join : (l@(P , φ , i) : 𝓛 G)
                             → l ＝ ⨆ i (λ (_ : P) → l)
...
Now we assume this for the sake of eventually concluding that the
principle of excluded middle holds.
