...
We may wonder whether, in an arbitrary topos, Ω with the structure map
⨆ = ∀ is freely generated by *any* object G of generators.
...
𝓛 G freely generated by G, with insertion of generators η : G → 𝓛 G,
and in particular a unique map h : 𝓛 G → Ω extending ι along η.
...
used in the proof of the above above claims, but may be interesting in
their own right.
