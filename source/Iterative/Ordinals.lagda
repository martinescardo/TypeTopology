...
so that 𝕆 is an ordinal in the sense of the HoTT book.
...
𝕆-to-Ord-reflects-order α β (y , p) = III
 where
  I = 𝕆-to-Ord (𝕆-forest β y) ＝⟨ (𝕆-to-Ord-square β y)⁻¹ ⟩
      (𝕆-to-Ord β ↓ y)        ＝⟨ p ⁻¹ ⟩
      𝕆-to-Ord α              ∎
...
And a second application of the above commutative square shows that
