...
rec-respects-≡ {σ} {a₁} {a₂} {b₁} {b₂} {succ c₁} {succ .c₁} e₁ e₂ refl =
 e₁ refl (rec-respects-≡ {c₁ = c₁} e₁ e₂ refl)
...
≡-refl (Rec t t₁ t₂) γ₁≡γ₂ =
 rec-respects-≡ (≡-refl t γ₁≡γ₂) (≡-refl t₁ γ₁≡γ₂) (≡-refl t₂ γ₁≡γ₂)
≡-refl (ν i) γ₁≡γ₂ = γ₁≡γ₂ i
...
⟦weaken⟧ (Rec t t₁ t₂) s γ₁ γ₂ γ₁≡γ₂ =
 rec-respects-≡ (⟦weaken⟧ t s γ₁ γ₂ γ₁≡γ₂) (⟦weaken⟧ t₁ s γ₁ γ₂ γ₁≡γ₂) (⟦weaken⟧ t₂ s γ₁ γ₂ γ₁≡γ₂)
