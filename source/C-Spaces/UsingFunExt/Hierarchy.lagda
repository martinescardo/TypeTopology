...
module C-Spaces.UsingFunExt.Hierarchy (fe : DN-funext 𝓤₀ 𝓤₀) where

open import UF.Base
open import UF.DiscreteAndSeparated

open import C-Spaces.Preliminaries.Sequence
open import C-Spaces.Preliminaries.FunExt fe
...
open import C-Spaces.UsingFunExt.IndiscreteSpace fe
