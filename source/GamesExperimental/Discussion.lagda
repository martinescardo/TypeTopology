...
module GamesExperimental.Discussion
        {𝓤 : Universe}
        (ua : Univalence)
...
the module GamesExperimental.?  ̇ Trees. We import the module here, but using
...
We now show how the file GamesExperimental.FiniteHistoryDependent could have been
...
Our conception of game, defined in GamesExperimental.FiniteHistoryDependent,
