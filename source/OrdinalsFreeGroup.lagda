...
an embedding if P is a proposition, and the terminal type 𝟙 is small
...
But the above resizing of ηη is not small enough for our purposes.
...
which proves the promised second lemma:
