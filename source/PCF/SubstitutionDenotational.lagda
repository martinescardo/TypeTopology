...
{-# OPTIONS --without-K --safe --exact-split --no-sized-types --no-guardedness --auto-inline --lossy-unification #-}
...
module PCF.SubstitutionDenotational
...
substitution-lemma {_} {_} {m} {Δ} (ƛ {n} {Γ} {σ} {τ} M) f e d g = e₂
  where
    ...
    e₂ = to-subtype-＝ (being-continuous-is-prop (⟦ σ ⟧ ⁻) (⟦ τ ⟧ ⁻)) (dfunext fe e₁)
