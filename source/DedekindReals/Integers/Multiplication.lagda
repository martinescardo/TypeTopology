...
is-pos-succ-trans x (negsucc y)           x>0 y>0 = 𝟘-elim y>0
is-pos-succ-trans x (pos 0)               x>0 y>0 = 𝟘-elim y>0
is-pos-succ-trans x (pos (succ 0))        x>0 y>0 = is-pos-succ-succℤ x x>0
