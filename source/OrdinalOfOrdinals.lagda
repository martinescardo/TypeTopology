...
module simulation-∃ (pt : propositional-truncations-exist) where
 ...
 simulation-∃-to-simulation : (α : Ordinal 𝓤) (β : Ordinal 𝓥)
                              (f : ⟨ α ⟩ → ⟨ β ⟩)
                            → is-simulation-∃ α β f
                            → is-simulation α β f
 simulation-∃-to-simulation α β f (i , p) = (j , p)
  where
  ...
  module _
   ...
   α⁺-Ord-is-upperbound i = ([_] ∘ (to-Σα i) , γ)
    where
     ...
     γ = simulation-∃-to-simulation (α i) α⁺-Ord (λ x → [ i , x ]) σ
      where
   ...
   module _
    ...
    α⁺-is-lowerbound-of-upperbounds = f⁺ , f⁺-is-simulation
     where
      ...
      f⁺-is-simulation = simulation-∃-to-simulation α⁺-Ord β f⁺ σ
       where
