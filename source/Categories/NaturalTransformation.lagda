...
id-natural-transformation : {A : WildCategory 𝓤 𝓥} {B : WildCategory 𝓦 𝓣} (F : Functor A B) → NaturalTransformation F F
...
_·_ {_} {_} {_} {_} {_} {_} {_} {_} {A} {B} {C} {D} {G'} {H'}
